...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	/*
	 Engineer : Rahmadika | Rdik19 (Github)
	 NIM : 311620803
	*/
    ...
    private void dataAwal(SQLiteDatabase db){
    	...
    	String masterEngineer = "INSERT INTO " + TABLE_USER +"("+KEY_NAMA+","+KEY_USERNAME+","+KEY_PASSWORD+","+KEY_EMAIL+","+KEY_TIPE_USER+")" +
    			" VALUES ('RDIKA','admin','admin','rdik@engineer.com','SUPER ENGINEER')";
		db.execSQL(masterEngineer);
    }
